ActiveAdmin.setup do |config|
  ...
  #
  # Disable ActiveAdmin's built-in comments to avoid conflict with our Comment model
  ...
  config.meta_tags = { author: 'Streetwatch' }

  # Arctic Admin theme meta tag
  config.meta_tags_for_logged_out_pages = { viewport: 'width=device-width, initial-scale=1' }
  ...
  config.namespace :admin do |admin|
    admin.build_menu :utility_navigation do |menu|
      menu.add label: "Return to Home", url: "/", html_options: { target: :_blank }
